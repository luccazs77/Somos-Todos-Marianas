import * as S from './SaibaMaisProfissionalizante.styled'
import acaoBeneficente from '../../../public/imagens/acaoBeneficente.jpeg'
import cursoEducacao from '../../../public/imagens/cursoEducacao.jpeg'
import cursoPolicia from '../../../public/imagens/cursoPolicia.jpeg'
import { BotaoTopo } from '../botao_topo/BotaoTopo'
...
<>
    <S.AllContainer>
        ...
        <S.DivContainer>
            <S.AcaoBeneficente src={acaoBeneficente} alt='Acao beneficente'/>
        ...
        <S.DivContainer>
            <S.CursoPolicia src={cursoPolicia} alt='CursoPolicia'/>
            <S.DivContainerTextos>
